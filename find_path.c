...
/**
 * find_program - finding a program in path
...
/**
 * tokenize_path - to tokenize the path in directories
 * @data: pointer to the program's data
...
/**
 * check_file - checking exist file, if it is not a dairectory and
 * if it excecution permisions for permisions.
 * @full_path: pointer to the file name
 * Return: 0 on success, or errorcode if it exists.
 */
